...
使用方法:
    python mask_to_3d.py --mask_dir output_seg --rgb_dir front/rgb --depth_dir front/depth --output_dir pointclouds

依赖:
    - numpy, opencv-python, pillow
    - open3d (用于点云处理)
    - pyrealsense2 (如果使用RealSense相机)
"""
...
def main():
    parser = argparse.ArgumentParser(description='从掩码生成3D点云')
